...
/**
 * Put the items that are included by both parents to a child, and items that are included by at least one of the
 * parents to another child
 */
public class SameAndBoth extends Crossover {
    @Override
